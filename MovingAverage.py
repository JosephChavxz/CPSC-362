...
df['order'] = 'N/A'
# If the 5-day moving average is larger than the 10-day moving average, set order as '1' (buy)
df.loc[df['5_day_ma'] > df['10_day_ma'], 'order'] = 'buy'
# If the 5-day moving average is less than the 10-day moving average, set order as '-1' (sell)
